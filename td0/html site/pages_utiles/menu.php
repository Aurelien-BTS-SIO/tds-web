<div id="menu">
    ...
    <ul class="menu">
        <a href="index.php" class="menu_item">Accueil</a>
        <a href="a propos.php" class="menu_item">À propos</a>
        <a href="competences.php" class="menu_item">Compétences</a>
        <a href="experiences.php" class="menu_item">Expériences</a>
        <a href="formations.php" class="menu_item">Formations</a>
    ...
    <ul class="contact">
        ...
        <div class="hover-bg">
            <a id="closeBtn" href="#" class="close">
                <span id="toClose" class="material-symbols-outlined">
                    close
                </span>
            </a>
        </div>
